                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-widget-info">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-envelope" /> support@unohr.com
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-phone" /> +1 916-800-1425
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-map-marker-alt" /> Address <br/>unoHR.com
                                            717 <br/> K Street STE 207<br/>
                                            Sacramento, CA 95814
                                        </a>
                                    </li>
                                </ul>

...
function HomeOneHeader({
    ...
    return (
        <header className={`unoHR-header-area unoHR-sticky ${className || ''}`}>
                ...
                <div className="header-nav-box">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-1 col-sm-1 order-3 order-sm-2">
                            <div className="unoHR-header-main-menu">
                                <Navigation />
                            </div>
                        </div>
                        <div className="col-lg-4  col-md-7 col-sm-6 col-6 order-2 order-sm-3">
                            <div className="unoHR-btn-box text-right">
                                {darkEnable &&
                                    (dark ? (
                                        <span
                                ...
                                <a className="main-btn ml-10" href="https://zoom.us/">
                                    Schedule Demo
                                </a>

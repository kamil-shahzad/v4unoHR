...
function TestimonialHomeOne({ className }) {
    ...
    return (
        <section
            className={`unoHR-testimonial-area pt-100 pb-160 ${className || ''}`}
            id="testimonial"
        >
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-8">
                        <div className="unoHR-testimonial-slider" style={{ position: 'relative' }}>
                            <span
                            ...
                            <Slider ref={sliderRef} dots arrows={false}>
                                <div className="unoHR-testimonial-item text-center">
